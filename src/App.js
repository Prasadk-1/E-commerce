                    ...
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">                   
                      {
                        ...
                        <div class="text-center"><button class="btn btn-outline-dark mt-auto" onClick={()=>handleAddCart(18)}>Add to cart</button></div>                      
                      };
                    ...
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        {
                            siSelected?
                             ...
                             <div class="text-center"><button class="btn btn-outline-dark mt-auto" onClick={()=>handleAddCart(25)}>Add to Cart</button></div>
}
                        </div>
                </div>
            </div>
